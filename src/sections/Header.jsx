                    ...
                    <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto'>
                        <ul className="flex max-lg:block max-lg:px-12">
                            ...
                            <li className='nav-li'>
                                <NavLink title='faq' />
                                <div  className='dot'/>
                                <NavLink title='donwloads' />
                            </li>
                        </ul>
                    </nav>
                </div>
            </div>
            <button className='lg:hidden z-2 size-10 border-2 border-s-4/25 rounded-full flex justify-center items-center' onClick={()=>setIsOpen((prevState)=>!prevState)}>
                <img
